    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] p-6 font-mono relative overflow-hidden">
      ...
      >
        ...
        <motion.button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-white text-black border border-white hover:bg-gray-200 transition-all mb-4 disabled:opacity-50 uppercase tracking-widest text-sm font-bold"
